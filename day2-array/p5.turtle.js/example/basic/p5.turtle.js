...
setup = function() {
	var canvas = createCanvas(1440, 1080);
	...
	const usedColors = ['###', 'gray', 'blue', 'red', 'green']; //purple and cyan are not valid colors
	for(let t = 1; t < 5; t++) {
		console.log(t, usedColors[t]);
		turtle.penColor = eval("turtle.color." + usedColors[t]);
		for(let i = 0; i < 4; i++){
